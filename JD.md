...
| [飞桨AI编译器研发工程师](#compile)| 实习生  | 北京/上海/深圳 | 
...
<a id="compile"></a>
### 飞桨AI编译器研发工程师
本岗位适用于实习生，工作地点为北京/上海/深圳。

【工作职责】
- 负责飞桨AI编译器的设计与研发及落地
- 面向CPU/GPU/FPGA/ASIC等多元化计算架构开展深度学习编译系统开发、优化和算法加速等工作。
- 深度学习编译器的前后端、自动代码生成等。
- 搭建并改进代码开发智能体。
- 参与开源社区建设，与全球开发者共同推动飞桨生态的繁荣。

【职责要求】
- 本科及以上学历，计算机科学、电子工程、软件工程等相关专业。
- 熟悉 C/C++、Python,熟悉linux,熟练掌握程序设计算法与数据结构
- 熟悉 PaddlePaddle、Pytorch、Tensorflow 等主流深度学习框架者优先
- 熟悉MLIR、TVM、inductor等编译器技术者优先
- 有编程助手产品核心模块开发（代码补全/质量检测）经验者优先
